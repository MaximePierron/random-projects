...
/**
 * Main Elementor Custom Class
 *
 * The init class that runs the Elementor Custom plugin.
...
final class Elementor_Custom {
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_CUSTOM ) );
		return sprintf(
			wp_kses(
...
// Instantiate Elementor_Custom.
new Elementor_Custom();